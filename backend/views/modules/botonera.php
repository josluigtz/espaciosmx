...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<img src="views/images/espacios-app-back.jpg" class="img-responsive" alt="Image">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
			...
			<ul class="nav navbar">
				...
				<li><a href="slide">Slide Publicidad<span class="glyphicon glyphicon-new-window"></span></a></li>
				<li><a href="articulos">Publicaciones <span class="glyphicon glyphicon-new-window"></span></a></li>
