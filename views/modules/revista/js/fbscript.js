    ...
    if(hasMobileVersion && !isBelowIE8()){
    	var pageIndex=getURLParam('pageIndex');
		  if(!pageIndex){
			...
			document.write("Sorry,need flash player. <a href='http://www.adobe.com/go/getflashplayer'>Get Adobe Flash Player<\/a> it's possible to <a id='linkSEO' href='mobile/index.html'>view a simplified version of the book on any device</a>, or you can view the mobile version <a href='mobile/index.html'> here </a>" ); 
		} 
    return false; 
  }  
};
